<template>
  <div class="letter">
    ...
    >
      <button
        @click="switchView(View.LETTER)"
        type="button"
        class="letter__sendform-backbtn u-font-sm"
      >
        <svg
          width="28"
          height="6"
      ...
      <div v-if="!isSenderNameFieldHidden" class="letter__sendform-field">
      ...
      <div class="letter__sendform-field letter__sendform-field--checkbox">
        ...
        <input type="checkbox" class="u-font-normal" v-model="isFeatured" />
      </div>
      <button
...
const handleLetterSend = async () => {
  try {
    ...
    alert(
      "Your letter has been successfully sent. I hope it brings you warmth ❤️"
    );
